...
$IPTABLES -A FORWARD -p icmp -s 10.0.2.15 -i $Client_NET_IFACE -d 8.8.8.8 -j ACCEPT
...
#
$IPTABLES -A INPUT -p TCP --dport 80 -i $Client_NET_IFACE -s 10.0.2.15 -j ACCEPT
$IPTABLES -A INPUT -p TCP --dport 443 -i $Client_NET_IFACE -s 10.0.2.15 -j ACCEPT
...
$IPTABLES -A INPUT -p icmp -d $WEB_IP_ADDRESS -j REJECT 
...
$IPTABLES -A OUTPUT -p TCP --sport 80 -o $Client_NET_IFACE -d 10.0.2.15 -j ACCEPT
$IPTABLES -A OUTPUT -p TCP --sport 443 -o $Client_NET_IFACE -d 10.0.2.15 -j ACCEPT
